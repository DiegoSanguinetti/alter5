...
return array(
    'header' => array(
        ...
        'Sign Up', //4
        'Join as Developer', //5
        'Finance solar and photovoltaic projects throughout Europe through a Green Bond program partially guaranteed by the European Investment Fund.', //6
    ...
    'home' => array(
        ...
        'Developer', //2
        'Investor', //3
        'Renewable energy assets', //4
        'Investment Opportunities', //5
        'Tonne CO2 emissions avoided', //6
        "Una plataforma abierta para <br class='md-hidden'>acelerar la transición energética", //7
        ...
        "Alter5 provides a fully digital process for renewable energy asset owners and developers. Via the Alter5 Asset Portal, they can upload the project information. Alter5 has developed a process by which renewable energy developers with process and asset owners with a fully digital process through which they can upload their projects and for a debt financial structuring or M&A transactions. Optionally they have access to request for construction quotation, asset management, PPAs, etc., from the platform itself. Through specially designed algorithms, the platform financially structures the operation automatically according to the promoter's requirements and the possibilities of the project, and distributes it among institutional investors interested in acquiring or financing those projects directly or through the Green Transition Bond, a Green Bond program partially guaranteed by the European Investment Fund.", //9
        'Learn more as Developer', //10
        'Institutional investors can access different debt and equity strategies in a wide variety of previously curated wind and photovoltaic projects to invest directly (Direct Investment) or through the Green Transition Bond, the Green Bond program designed by <span class="bold">Alter5</span> and partially guaranteed by the European Investment Fund. Green Transition Bond investors can access their dashboards where the returns and ESG impact of their investments are reflected.', //11
        ...
        'Load More Insights',//14
    ),
    'promotores' => array(
        'Developer registration form', //0
        'Developers', //1
        ...
        'Financing program for wind and photovoltaic farms.', //7
        ...
        '<li>Alter5 gives you access to a multitude of investors from all over the world who acquire projects with VATs, RTBs and Parks in Operation or will to partner with developers</li>
        <li>Create your project on the platform in minutes</li>
        <li>Decide which investors you want to make known to</li>
        <li>Receive offers in a way and interact with buyers or potential partners on the immediate platform</li>',//14
        ...
        'Alter5 Efficiency AA5DS supports developers, allowing them on the platform itself to search and select very different renewable energy providers (EPC, Asset & Management, PPAs, legal services, etc.). A5DSlter5 efficiency allows promoters from the Alter5 partner network and purchase prices to receive different quotes from the Alter5 supplier network.', //21
    ...
    'promotores-clean-energy' => array(
        ...
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. </p>
                            <p class="small">Sed in elit consectetur, vestibulum nunc quis, facilisis nunc. Donec vestibulum suscipit diam a blandit. Proin hendrerit turpis eget enim dapibus pellentesque.', //13
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. </p>
                            <p class="small">Sed in elit consectetur, vestibulum nunc quis, facilisis nunc. Donec vestibulum suscipit diam a blandit. Proin hendrerit turpis eget enim dapibus pellentesque.', //14
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. </p>
                            <p class="small">Sed in elit consectetur, vestibulum nunc quis, facilisis nunc. Donec vestibulum suscipit diam a blandit. Proin hendrerit turpis eget enim dapibus pellentesque.', //15
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. </p>
                            <p class="small">Sed in elit consectetur, vestibulum nunc quis, facilisis nunc. Donec vestibulum suscipit diam a blandit. Proin hendrerit turpis eget enim dapibus pellentesque.', //16
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. </p>
                            <p class="small">Sed in elit consectetur, vestibulum nunc quis, facilisis nunc. Donec vestibulum suscipit diam a blandit. Proin hendrerit turpis eget enim dapibus pellentesque.', //17
    ...
    'promotores-compraventas' => array(
        ...
        'Sale of wind farms <br>in development, RTB<br>and operation</h4>
                        <p>Through the sale and purchase program Alter5 allows developers wishing to sell projects in any stage (development, RTB and operation) to contact a pool of institutional buyers (funds, family-offices, large utilities, IPPs).', //1
        'Submit your project and receive an indicative offer of financing', //2
        'Name', //3
        'Surname', //4
        'Company', //5
    ...
    'promotores-financiacion' => array(
        ...
        'Semestre', //20
        'Send', //21
        'Maximize the price of your project', //22
        'Los parques en operación tienen un valor muy superior a los parques en RTB. La diferencia entre el valor de un parque en RTB u operación puede alcanzar hasta los 200.000€ por MW.', //23
        '100% de los costes de construcción desde el 4%', //24
        'Financia la totalidad de los costes de construcción.', //25
        'Devolución hasta en 15 años', //26
        'El programa de construcción te incluye la refinanciación además de la construcción con plazos de devolución a largo plazo.', //27
        'Confidentiality and control', //28
        'The entire process is strictly confidential to safeguard the information provided by the developers, who decide to whom to provide information.', //29
    ...
    'inversores' => array(
        'Formulario registro inversor', //0
        'Investors', //1
        ...
        'European Clean<br>Energy Bond', //6
        'The European Clean Energy Bond is a green bond program for financing the construction of photovoltaic and wind farms. </span>Up to 70% of the debt is guaranteed by the European Investment Fund. The product has a short-term structure (3 years) with an average rate of 4.5% and a long-term structure (18 years) with a rate of 2.25%.', //7
    ...
    'inversores-alter5-impact' => array(
        ...
        'Other Products ', //20
        'European Clean<br>Energy Bond', //21
    ...
    'inversores-equity-debt' => array(
        ...
        'Sed in elit consectetur, vestibulum nunc quis, facilisis nunc. Donec vestibulum suscipit diam a blandit. Proin hendrerit turpis eget enim dapibus pellentesque.', //12
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', //13
        'Sed in elit consectetur, vestibulum nunc quis, facilisis nunc. Donec vestibulum suscipit diam a blandit. Proin hendrerit turpis eget enim dapibus pellentesque.', //14
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', //15
        'Sed in elit consectetur, vestibulum nunc quis, facilisis nunc. Donec vestibulum suscipit diam a blandit. Proin hendrerit turpis eget enim dapibus pellentesque.', //16
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', //17
        'Sed in elit consectetur, vestibulum nunc quis, facilisis nunc. Donec vestibulum suscipit diam a blandit. Proin hendrerit turpis eget enim dapibus pellentesque.', //18
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', //19
        'Sed in elit consectetur, vestibulum nunc quis, facilisis nunc. Donec vestibulum suscipit diam a blandit. Proin hendrerit turpis eget enim dapibus pellentesque.', //20
        'Other Products', //21
        'European Clean<br>Energy Bond', //22
        'Access the program', //23
        'Alter5 Impact<br>Investing Dashboard' //24
    ),
    'inversores-european-clean-energy' => array(
        'Investors</span> | European Clean Energy Bond', //0
        'European Clean<br>Energy Bond', //1
        'The European Clean Energy Bond is a green bond program for financing the construction of photovoltaic and wind farms. Up to 70% of the debt is guaranteed by the European Investment Fund. The product has a short-term structure (3 years) with an average rate of 4.5% and a long-term structure (18 years) with a rate of 2.25%.', //2
        'Submit your project and receive an indicative offer of financing', //3
        'Name', //4
        'Surname', //5
        'Company', //6
    ...
    'news' => array(
        'News & Insights', //0
        'Load More Insights' //1
    ),
    'contacto' => array(
        'Contact', //0
        'Fill the form below to find out more about Alter5 Investor and Origination Networks', //1
        'Full Name', //2
        'Email address', //3
        'Phone number', //4
        'Company', //5
        'Message', //6
        'I agree to the Terms and Conditions and Privacy Policy.', //7
        'Send to' //8
    ),
    'legal' => array(
        'All about terms', //0
    ...
    'privacy' => array(
        ...
        'For the exercise of these rights the User may contact Alter 5 by regular mail (address above at the identification of the data controller) or sending an e-mail to privacy@alter-5.com.', //19
