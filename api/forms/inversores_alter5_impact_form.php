...
$inversores_alter5_impact = new Formulario(
	array(
		'destinatarios' => array(
 			'miguel.solana@alter-5.com',
 			'manuel.rojo@alter-5.com'
 		),
		'asunto' 	=> 'Inversores impact - '.Config::obtener('empresa')->nombre,
		'remitente' => array(
...
$inversores_alter5_impact->agregarCampos(
	array(
...
if( isset($_POST['envia_inversores_alter5_impact']) ){
	$inversores_alter5_impact->enviar();
}
