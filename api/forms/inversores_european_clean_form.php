...
$inversores_european_clean = new Formulario(
	array(
		'destinatarios' => array(
 			'miguel.solana@alter-5.com',
 			'manuel.rojo@alter-5.com'
		),
		'asunto' 	=> 'Inversores European Clean Energy - '.Config::obtener('empresa')->nombre,
		'remitente' => array(
...
$inversores_european_clean->agregarCampos(
	array(
...
if( isset($_POST['envia_inversores-european-clean-energy']) ){
	$inversores_european_clean->enviar();
}
